...
pub mod contract {
    ...
    pub struct Erc721 {
        ...
        enumerable: enumerable::Data<Erc721>,
    }
    ...
    impl erc721::Impl<Erc721> for Erc721 {
        fn _before_token_transfer(
            ...
            erc721::enumerable::Impl::before_token_transfer(self, from, to, token_id)
        }
    ...
    impl erc721::enumerable::Impl<Erc721> for Erc721 {}
    ...
    impl Erc721 {
        ...
        pub fn new(name: String, symbol: String) -> Self {
            let mut instance = Self {
                ...
                enumerable: enumerable::Data::default(),
            };
